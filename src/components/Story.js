    ...
    return (
      <div className="story-wrapper">
            <div className="text-content">
              ...
              : <><h3 className="cursor-effect" onClick={() => setShowIntro(true)}>Introduction<img src="../down-arrow.png" className="arrow-image" /></h3></>
              } 
              <hr className="divider" />
              <section>
                <h3><img className="marker" src="../markers/1.png"/> The Old Rectory</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/2.png"/> Church Farm</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/3.png"/> Crayke Cottage</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/4.png"/> Churton Hall</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/5.png"/> The Pinfold</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/6.png"/> Tudor Cottage</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/7.png"/> The Homestead</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/8.png"/> The Durham Ox</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/9.png"/> Ivy Farm</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/10.png"/><img className="marker" src="../markers/11.png"/> Rose Cottage and Priest Cottages</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/12.png"/> The Old Bakery</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/13.png"/> Whistling Green</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/14.png"/> Village Green</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/15.png"/> The Well</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/16.png"/> Wellesley Cottage</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/17.png"/> Crayke Hall</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/18.png"/> St Cuthbert's Church</h3>
              ...
              <section>
                <h3><img className="marker" src="../markers/19.png"/> Crayke Castle</h3>
