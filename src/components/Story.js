    ...
    return (
      <div className="story-wrapper">
            <div className="text-content">
              ...
              { showIntro ?
              <>
                <h3 onClick={() => setShowIntro(false)}>[icon] Introduction [uparrow]</h3>
                  <section>
              ...
              : <h3 onClick={() => setShowIntro(true)}>[icon] Introduction [downarrow]</h3>
              } 
              <hr className="divider" />
              <h3>[icon] The Trail</h3>
              <section>
                <h3>[NUMBER 1] [IMAGE]</h3>
